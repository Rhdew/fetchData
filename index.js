...
const fetchData = async () => {
  try {
    let product = 1;
    for (let i = 1; i < 3; i++) {
      const URL = `https://www.flipkart.com/search?q=mobiles&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off&as-pos=1&as-type=HISTORY&page=${i}`;
